@testset "Invalid data points" begin
    ...
    basketball = @test_nowarn readc3d(joinpath(datadir, "sample16", "basketball.c3d"), withmissings=false)
    ...
    giant = @test_nowarn readc3d(joinpath(datadir, "sample16", "giant.c3d"), withmissings=false)
    ...
    golf = @test_nowarn readc3d(joinpath(datadir, "sample16", "golf.c3d"), withmissings=false)
