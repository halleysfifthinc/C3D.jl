@testset "Invalid data points" begin
    ...
    basketball = @test_nowarn readc3d(joinpath(datadir, "sample16", "basketball.c3d"), invalidate=false)
    ...
    giant = @test_nowarn readc3d(joinpath(datadir, "sample16", "giant.c3d"), invalidate=false)
    ...
    golf = @test_nowarn readc3d(joinpath(datadir, "sample16", "golf.c3d"), invalidate=false)
