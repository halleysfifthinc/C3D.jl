@testset verbose=true "Editing" begin
    # Shared test data
    ...
    @testset verbose=true "deletepoint!" begin
    ...
    @testset verbose=true "deleteanalog!" begin
        f = readc3d(sample01_fn)
    ...
    @testset verbose=true "deleteforceplate!" begin
        f = readc3d(sample01_fn)
